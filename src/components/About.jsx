            ...
            <div className='max-w-[1240] mx-auto px-4 py-16'>
                <div>
                    ...
                    <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4'>
                        ...
                        <AboutCard icon={<SiHiveBlockchain size={40} />} heading='Secure off-chain computation' text='Integrate pre-built, time-tested oracle solutions that already secure tens of billions in smart contract value for market leading decentralized applications.' />
